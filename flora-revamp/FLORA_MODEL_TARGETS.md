...
- **Image** — link to the generated reference plate in [`images/`](images/). All
  **P0**, **P1** and **P2** plates are generated with
  [`generate_images.py`](generate_images.py) (uses GPT Image 2 and the prompts
  below); every row now has its plate.
...
| Standing dead snag | [standing-dead-snag.png](images/standing-dead-snag.png) | A single bare, branchless or broken-topped dead trunk left standing. Cheap silhouette variety in forest and boreal stands. Representative: fire-killed conifer snag. | A single bare standing dead tree snag, branchless weathered silver-grey trunk with a broken jagged top and remnants of cracked bark, no leaves. Photorealistic, single isolated specimen centered and fully in frame, plain seamless neutral mid-grey background, soft even diffuse lighting, no cast shadows, slight 3/4 viewing angle, sharp focus, high detail, no text, no people, no watermark. | **P2** |
...
| Fern | [fern.png](images/fern.png) | A single low, lacy frond plant for damp shaded forest floor. Representative: bracken / lady fern. | A single bracken fern plant, lacy arching green fronds radiating from one central base. Photorealistic, single isolated specimen centered and fully in frame, plain seamless neutral mid-grey background, soft even diffuse lighting, no cast shadows, slight 3/4 viewing angle, sharp focus, high detail, no text, no people, no watermark. | **P2** |
| Wildflower | [woodland-wildflower.png](images/woodland-wildflower.png) | A single small flowering plant for clearings and edges. Representative: woodland aster / foxglove. | A single woodland wildflower plant, a slender green stem topped with purple and white blossoms. Photorealistic, single isolated specimen centered and fully in frame, plain seamless neutral mid-grey background, soft even diffuse lighting, no cast shadows, slight 3/4 viewing angle, sharp focus, high detail, no text, no people, no watermark. | **P2** |
...
| Agave / yucca rosette | [agave-rosette.png](images/agave-rosette.png) | A single rosette of stiff sword-leaves, sometimes with a tall flower spike. Representative: agave / Joshua-tree yucca. | A single agave rosette of thick stiff blue-green sword-shaped leaves with sharp tips, radiating symmetrically from one center. Photorealistic, single isolated specimen centered and fully in frame, plain seamless neutral mid-grey background, soft even diffuse lighting, no cast shadows, slight 3/4 viewing angle, sharp focus, high detail, no text, no people, no watermark. | **P2** |
| Dry dead bush | [dead-bush.png](images/dead-bush.png) | A single leafless tangled shrub / tumbleweed form for desolation. Representative: dead sagebrush / tumbleweed. | A single small leafless tangled dead shrub, dry grey woody twigs in a rounded brittle tumbleweed mass. Photorealistic, single isolated specimen centered and fully in frame, plain seamless neutral mid-grey background, soft even diffuse lighting, no cast shadows, slight 3/4 viewing angle, sharp focus, high detail, no text, no people, no watermark. | **P2** |
...
All three tiers (**P0**, **P1**, **P2**) are now wired into the script and have
reference plates in `images/`. Regenerate a tier with `--priority {P0,P1,P2}`.
